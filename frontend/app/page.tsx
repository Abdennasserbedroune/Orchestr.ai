          ...
          >
            ...
            <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between">
              <div className="flex items-center gap-1">
                <button type="button" aria-label="Attach file" className="w-9 h-9 flex items-center justify-center rounded-full text-[#3f3f46] hover:text-[#a1a1aa] hover:bg-white/[0.05] transition-all">
                  <Paperclip size={18} strokeWidth={1.5} aria-hidden="true" />
                </button>
                <button type="button" aria-label="Tools (locked)" className="w-9 h-9 flex items-center justify-center rounded-full text-[#3f3f46] hover:text-[#a1a1aa] hover:bg-white/[0.05] transition-all relative">
              ...
              <div className="flex items-center gap-1">
                <button type="button" aria-label="Voice input" className="w-9 h-9 flex items-center justify-center rounded-full text-[#3f3f46] hover:text-[#a1a1aa] hover:bg-white/[0.05] transition-all">
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col gap-3">
              <Link href="/login" className="w-full flex items-center justify-center gap-2 bg-white text-black hover:bg-gray-100 transition-colors rounded-[12px] py-3 text-[15px] font-semibold">
                Se connecter <ArrowRight size={16} aria-hidden="true" />
              </Link>
              <Link href="/register" className="w-full flex items-center justify-center gap-2 bg-[#18181b] border border-white/[0.08] text-foreground hover:bg-[#222] transition-colors rounded-[12px] py-3 text-[15px] font-medium">
                Cr&eacute;er un compte
              </Link>
            </div>
            <button type="button" onClick={() => setShowRedirect(false)} className="mt-6 w-full text-center text-[13px] text-[#3f3f46] hover:text-[#71717a] transition-colors">
              Annuler
            </button>
          </div>
        </div>

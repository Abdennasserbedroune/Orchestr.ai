...
export const AGENTS_CATALOG: AgentFull[] = [
  {
    ...
    compatibleTools: ['Notion', 'WordPress', 'Webflow', 'Mailchimp', 'Buffer', 'HubSpot'],
    n8nWorkflow: true,
    playbook: [
  ...
  },
  {
    ...
    compatibleTools: ['HubSpot', 'Salesforce', 'Pipedrive', 'Apollo', 'LinkedIn', 'Gmail'],
    n8nWorkflow: true,
    playbook: [
  ...
  },
  {
    ...
    compatibleTools: ['n8n', 'Zapier', 'Slack', 'Notion', 'Airtable', 'Google Workspace'],
    n8nWorkflow: true,
    playbook: [
  ...
  },
  {
    ...
    compatibleTools: ['Perplexity API', 'SerpAPI', 'Twitter/X', 'Crunchbase', 'LinkedIn', 'Notion'],
    n8nWorkflow: false,
    playbook: [
  ...
  },
  {
    ...
    compatibleTools: ['QuickBooks', 'Xero', 'Stripe', 'Mercury', 'Notion', 'Google Sheets'],
    n8nWorkflow: true,
    playbook: [
  ...
  },
  {
    ...
    compatibleTools: ['Greenhouse', 'Lever', 'Notion', 'Slack', 'Google Calendar', 'Typeform'],
    n8nWorkflow: true,
    playbook: [
  ...
  },
  {
    ...
    compatibleTools: ['GitHub', 'Linear', 'Notion', 'Postman', 'Vercel', 'Supabase'],
    n8nWorkflow: false,
    playbook: [
